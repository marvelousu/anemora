        ...
        private static LightingProfile CreateProfile(FastVsHouseArea area)
        {
            switch (area)
            {
                ...
                case FastVsHouseArea.Library:
                    return new LightingProfile
                    {
                        mainLightIntensity = 0.76f,
                        mainLightShadowStrength = 0.62f,
                        mainLightColor = new Color(1.00f, 0.86f, 0.64f, 1f),
                        mainLightRotation = Quaternion.Euler(54f, -28f, 0f),
                        ambientLight = new Color(0.128f, 0.120f, 0.111f, 1f),
                        fogEnabled = true,
