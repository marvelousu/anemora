        ...
        private static LightingProfile CreateProfile(FastVsHouseArea area)
        {
            switch (area)
            {
                case FastVsHouseArea.Exterior:
                    ...
                    {
                        mainLightIntensity = 1.04f,
                        mainLightShadowStrength = 0.54f,
                        mainLightColor = new Color(1.00f, 0.94f, 0.82f, 1f),
                        mainLightRotation = Quaternion.Euler(50f, -36f, 0f),
                        ambientLight = new Color(0.245f, 0.255f, 0.265f, 1f),
                        fogEnabled = true,
                        fogColor = new Color(0.130f, 0.150f, 0.170f, 1f),
                        fogStartDistance = 20f,
                        fogEndDistance = 82f,
                        cameraBackgroundColor = new Color(0.118f, 0.142f, 0.166f, 1f),
                        warmFillPosition = new Vector3(7.10f, 1.50f, 6.75f),
                        warmFillIntensity = 0.18f,
                        warmFillRange = 8.0f,
                        warmFillColor = new Color(1.00f, 0.76f, 0.48f, 1f),
                        coolRimRotation = Quaternion.Euler(32f, 146f, 0f),
                        coolRimIntensity = 0.070f,
                ...
                case FastVsHouseArea.CentralPlaza:
                    return new LightingProfile
                    {
                        ...
                        mainLightShadowStrength = 0.56f,
                        mainLightColor = new Color(1.00f, 0.92f, 0.78f, 1f),
                        mainLightRotation = Quaternion.Euler(49f, -31f, 0f),
                        ambientLight = new Color(0.235f, 0.245f, 0.260f, 1f),
                        fogEnabled = true,
                        fogColor = new Color(0.118f, 0.138f, 0.160f, 1f),
                        fogStartDistance = 18f,
                        fogEndDistance = 90f,
                        cameraBackgroundColor = new Color(0.112f, 0.138f, 0.164f, 1f),
                        warmFillPosition = new Vector3(20.80f, 1.25f, 17.30f),
                        warmFillIntensity = 0.14f,
                        warmFillRange = 10.0f,
                        warmFillColor = new Color(1.00f, 0.72f, 0.42f, 1f),
                        coolRimRotation = Quaternion.Euler(28f, 152f, 0f),
                        coolRimIntensity = 0.075f,
                ...
                case FastVsHouseArea.Library:
                    return new LightingProfile
                    {
                        mainLightIntensity = 0.74f,
                        mainLightShadowStrength = 0.50f,
                        mainLightColor = new Color(1.00f, 0.86f, 0.64f, 1f),
                        mainLightRotation = Quaternion.Euler(54f, -28f, 0f),
                        ambientLight = new Color(0.155f, 0.145f, 0.135f, 1f),
                        fogEnabled = true,
                        fogColor = new Color(0.075f, 0.068f, 0.060f, 1f),
                        fogStartDistance = 8f,
                        fogEndDistance = 38f,
                        cameraBackgroundColor = new Color(0.050f, 0.046f, 0.044f, 1f),
                ...
                default:
                    return new LightingProfile
                    {
                        mainLightIntensity = 0.86f,
                        mainLightShadowStrength = 0.48f,
                        mainLightColor = new Color(1.00f, 0.88f, 0.72f, 1f),
                        mainLightRotation = Quaternion.Euler(46f, -42f, 0f),
                        ambientLight = new Color(0.205f, 0.195f, 0.190f, 1f),
                        fogEnabled = false,
                        fogColor = new Color(0.080f, 0.074f, 0.070f, 1f),
                        fogStartDistance = 10f,
                        fogEndDistance = 42f,
                        cameraBackgroundColor = new Color(0.064f, 0.060f, 0.060f, 1f),
