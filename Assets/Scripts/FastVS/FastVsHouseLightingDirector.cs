        ...
        private static LightingProfile CreateProfile(FastVsHouseArea area)
        {
            switch (area)
            {
                ...
                case FastVsHouseArea.CentralPlaza:
                    return new LightingProfile
                    {
                        mainLightIntensity = 1.84f,
                        mainLightShadowStrength = 1.00f,
                        mainLightColor = new Color(1.00f, 0.74f, 0.42f, 1f),
                        mainLightRotation = Quaternion.Euler(GetUnifiedSunKeyLightEulerDegrees(FastVsHouseArea.CentralPlaza)),
                        ambientLight = new Color(0.052f, 0.044f, 0.034f, 1f),
                        fogEnabled = true,
                        fogColor = new Color(0.265f, 0.205f, 0.138f, 1f),
                        fogStartDistance = 8f,
                        fogEndDistance = 40f,
                        cameraBackgroundColor = new Color(0.196f, 0.158f, 0.104f, 1f),
                        warmFillPosition = new Vector3(20.80f, 1.25f, 17.30f),
                        warmFillIntensity = 0.012f,
                        warmFillRange = 9.8f,
                        warmFillColor = new Color(1.00f, 0.55f, 0.26f, 1f),
