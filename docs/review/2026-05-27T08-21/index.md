# Stage8i: Library Review Composition

Branch: `work/fast-vs-hd2d-shading-foundation-20260522`

Stage8i changes the Library public review capture composition so table, book, floor, and shelf details are easier to inspect. This review set is curated for public viewer legibility: numbered filenames make the representative thumbnail start from the bright plaza overview, and no external reference images, comparison boards, or obstructed route-close diagnostic shots are included.
...
![library review composition](02_library_review_composition.png)
...
- Stage8i improves public review legibility for Library details, but it is not a final visual judgment.
