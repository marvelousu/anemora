...
| 4 | Character v2 redraw + Resident review | Resident_A C3 fix C demoted | User review + Codex asset work | Hero and Resident_B are now the accepted visual reference. Resident_A v2 remains imported, but runtime review found its pixel feel too strong and its face/head scale too large against the Hero; C was directionally right but still large-headed. Both requested paths were tried: C3 32x48 headfix and stricter Hero-ratio D/E regeneration. User review then found C3 fix C's head/body connection reads detached and the preview is too blurry. | Do not runtime-import C3 fix C as-is. Next candidate needs a connected neck/collar/shoulder bridge and a crisp nearest-neighbor review sheet before approval; D/E still drift toward a Hero-like young resident. |
