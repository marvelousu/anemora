...
| 4 | Character v2 redraw + Resident review | Resident_A F/G/H review ready | User review + Codex asset work | Hero and Resident_B are now the accepted visual reference. Resident_A v2 remains imported, but runtime review found its pixel feel too strong and its face/head scale too large against the Hero; C was directionally right but still large-headed. C3 fix C was demoted because its head/body connection reads detached and the preview was too blurry. F/G/H were then extracted into a sharp nearest-neighbor comparison. | G is the strongest current review candidate because the neck/collar/shoulder bridge is readable and the head scale is not oversized. Do not runtime-import until user approves; F has a larger face, H reads softer. |
