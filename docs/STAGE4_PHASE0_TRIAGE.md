...
| 4 | Character v2 redraw + Resident review | Resident_A review sheet ready | User review + Codex asset work | Hero and Resident_B are now the accepted visual reference. Resident_A v2 remains imported, but runtime review found its pixel feel too strong and its face/head scale too large against the Hero; `docs/devlog/screenshots/stage4_resident_a_followup_review_sheet_abc.png` provides A/B/C concept options for review. | User selects A / B / C or requests regeneration before any Resident_A runtime replacement; targeted character tests and full PlayMode remain green after import. |
...
| Version | Date | Change |
|---|---|---|
| v0.5 | 2026-05-06 | Records Resident_A A/B/C follow-up review sheet as the next user gate before runtime replacement. |
