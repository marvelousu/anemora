...
- Replace the broken bookshelf approach with a front-facing bookshelf image panel, like a Minecraft-style bookshelf face.
...
- Build and structure validation:
  - `C:\Users\maro6\Documents\Unity\Anemora-fast-vs-v24-sample\Logs\fast_vs_build_validate_20260518_bookshelf_front_red_edges_v2.log`
  - Result: build succeeded and batchmode exited with return code 0.
- Screenshot capture:
  - `C:\Users\maro6\Documents\Unity\Anemora-fast-vs-v24-sample\Logs\fast_vs_capture_review_20260518_bookshelf_front_red_edges_v2.log`
...
- Player smoke:
  - `C:\Users\maro6\Documents\Unity\Anemora-fast-vs-v24-sample\Logs\fast_vs_player_smoke_20260518_bookshelf_front_red_edges.log`
