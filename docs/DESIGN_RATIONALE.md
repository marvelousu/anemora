...
- **却下した代替案**:
  - 1 周のみ (ループはストーリー設定だけ): 主人公がループを体験しない、Outer Wilds 的な驚きが弱まる
...
- **由来 / 理由**:
  - **Z2-c 二並行**: プレイヤーの推論能力に依存、Outer Wilds 系を強調 (C 軸補助と相性良)、Z 二段階より頭の中での結合を促す
...
- **却下した代替案**:
  - **構造案**:
    ...
    - 案 D 三並列気付き: Outer Wilds 系極致、ただしプレイヤー結合作業の負担増
  - **シーン 3 不在感演出代替案**:
...
- **却下した代替案**:
  ...
  - **案 2 螺旋構造**: 静謐 → 確証 → 気付き → 決断、螺旋的深化だが Outer Wilds 系で複雑、第 5 章の核心は案 4 ほど明確ではない
...
### 9.1 感情表現 E3: 顔 + 短い感情テキスト (Undertale 型)
- **決定**: E3 (顔表情画 + 短い感情テキスト)
- **由来 / 理由**:
  - 顔だけだと感情が伝わりにくい
  - 長文テキストは HD-2D Tier 2 の雰囲気を壊す
  - Undertale 型のミニマルな組み合わせが最適
- **却下した代替案**:
  - E1 (顔のみ): 感情の機微が伝わらない
  - E2 (長文テキスト): 雰囲気を壊す
  - E4 (フルボイス): 工数膨大
