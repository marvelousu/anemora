...
| 4 | 構造を作っているのは時の筆所有者 | 時の筆所有者は過去にも複数いた |
| 5 | **観測者輪廻が世界の正体** | 主人公自身が観測者の現再現 (主語反転) |
...
### 3.5 オープン要件 (Stage 3 で確定)

- 衰退原因の具体描写 (気候・大地の変容を比喩か実体か、TBD)
- 時の筆の起源 (主人公が選ばれた理由、TBD)
- 真層の収束パターン (複数案維持、Stage 3 で 1 つに絞る)
...
**名前 / 性別 / 年齢: TBD** (Stage 1 で意図的に未確定、Stage 3 で確定)

| 属性 | 仮置き |
|---|---|
| 年齢層 | 10 代後半 〜 20 代前半 (層遷移の認識更新に追従できる柔軟性) |
| 出身 | 第 1 ゾーンの街の住人 (TBD: 家族構成・職業) |
| 動機 | 衰退の予兆を受け、時の筆を手にして行動を始める |
| 性格 | 寡黙、観察的、能動的 (静かに動く) |
| 物語上の役割 | 各層で認識が更新される観測者、第 5 層で主語反転の主体となる |

> **重要**: `feedback_anemora_no_premature_lockin.md` 遵守 — 主人公の輪郭は Stage 3 ヒーロービジュアル制作時に確定する。Stage 2 では「観測者輪廻の主体になりうる」という機能要件のみ確定。
...
|---|---|---|
| 街の老人 | 第 1 ゾーンの語り手、衰退を受容している | 第 3 層で「衰退の構造的原因」を語る |
| 家族 (兄/姉/弟/妹 TBD) | 主人公の動機の核、過去への干渉対象 | 第 2 層で能動行動の代償が顕在化 |
| 別の時の筆所有者 | 過去にいた前任者、第 4 層で出現 | 第 4 層で「観測者は複数いた」を開示 |
| 観測者 (メタ) | 主人公が第 5 層で対峙する自己 | 第 5 層で主語反転 |
| サイド NPC × 数名 | 各ゾーンの違和感の核、サイドクエスト主体 | 各層でルール変化に応じた反応 |
...
| 対話 UI | テキストボックス + 選択肢 (簡素、フォント可読性優先) |
...
#### キャラクター
- [ ] 主人公の名前 / 性別 / 年齢 / 出身詳細 (§4.1)
- [ ] 主要登場人物 5-8 人の個別シート化 (§4.2)

#### 物語
- [ ] 衰退原因の具体描写 (比喩か実体か、§3.5)
- [ ] 時の筆の起源 / 主人公が選ばれた理由 (§3.5)
- [ ] 真層の収束パターン (複数案 → 1 つに絞る、§3.3)
