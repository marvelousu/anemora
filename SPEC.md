...
| 沈黙設定 | **Silent protagonist** (silent 主人公の独立タイトル型)。主人公はしゃべらない、感情のみテキストウィンドウで表現 |
...
| 対話 UI | テキストボックス + 選択肢 (簡素、フォント可読性優先)。**主人公は silent protagonist** のため、NPC は一方的に話し、主人公側はテキストウィンドウで感情・反応の選択肢のみを表現 (silent 主人公の独立タイトル型) |
...
- [x] 主人公の性別 (中性表現で最終確定) / 年齢 (15-19 歳) / silent protagonist / 旅人風の帽子 / 動機 3 層 / 真相 — Stage 3 A トラック /spec で確定 (`docs/STAGE3_TBD_RESOLUTION.md` §2)
