...
| This task | Added F-based Resident_A F2/F3/F4 refinement comparison; F2 is the strongest current review candidate, pending user approval before any runtime import. |
