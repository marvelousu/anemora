...
| This task | Added Resident_A C3 32x48 headfix prototypes and D/E Hero-ratio regeneration comparisons; later user review demoted C3 fix C because the head/body connection reads detached and the preview is too blurry for approval. |
| This task | Added sharp nearest-neighbor Resident_A F/G/H connected-candidate comparison; user review demoted G because the hair is too short and preferred the F direction. |
| This task | Added F-based Resident_A F2/F3/F4 refinement comparison; user review rejected F2 and narrowed the viable direction to F or F4, pending clearer Resident_A role framing. |
